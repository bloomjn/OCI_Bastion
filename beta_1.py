...
#Known issues 
# (Minor) Windows sends a sigterm instead of sigint, forcefully closing the session and leaving a stale bastion session. There is not an easy way to jump back into an active session if the user decides they want to pick up a new session.
#
